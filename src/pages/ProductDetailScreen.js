        ...
        <>
            <ScrollView horizontal={false} showsVerticalScrollIndicator={false}>
                <SafeAreaView style={styles.container}>
                    <View style={{backgroundColor: '#E941411A', borderRadius: 10, width: 360, height: 390, justifyContent: 'center', alignItems: 'center', marginVertical: 15}}>
                        <Image style={{ height: 340, width: 300 }} resizeMode="contain" source={data.image} />
                    </View>
                    <View style={{marginVertical: 20}}>
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                            ...
                            <Text style={[styles.textStyle, {color: '#000', fontSize: 25, fontWeight: 'medium'}]}>{data.price}$</Text>
                        </View>
                    </View>
                    <View style={{marginVertical: 20}}>
