        ...
        <>
            <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
                <SafeAreaView style={styles.container}>
                    <View> 
                        <Text style={[styles.textStyle, { marginVertical: 30, color: '#E94141', fontSize: 25 }]}>The world’s Best Bike</Text>
                        <ScrollView showsHorizontalScrollIndicator={false} horizontal>
                            <View style={{ flex: 1, flexDirection: 'row', marginBottom: 20 }}>
                                {types.map((item, index) => {
                                    return <TouchableOpacity key={item.id} style={{ borderRadius: 5, borderColor: '#E9414187', width: 100, alignItems: 'center', justifyContent: 'center', paddingVertical: 10, borderWidth: 1, marginHorizontal: 20 }} onPress={() => setTypeChoose(item)}>
