        ...
        <>
            <SafeAreaView style={styles.container}>
                <View style={{flex: 3, justifyContent: 'center'}}>
                    <Text style={[styles.textStyle, {fontFamily: 'VT323', fontSize: 26, fontWeight: 'bold', textAlign: 'center'}]}>A premium online store for sporter and their stylish choice</Text>
                </View>
